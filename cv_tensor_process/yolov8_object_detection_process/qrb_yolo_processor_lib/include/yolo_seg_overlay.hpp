...
#ifndef _QRB_YOLO_SEGMENTATION_OVERLAY_HPP_
#define _QRB_YOLO_SEGMENTATION_OVERLAY_HPP_
...
{
class YoloSegOverlay
{
public:
  YoloSegOverlay() = default;
  ~YoloSegOverlay() = default;
...
#endif  // _QRB_YOLO_SEGMENTATION_OVERLAY_HPP_