  ...
  : Node("yolo_preprocess_node", options)
{
  ...
  processor_ = std::make_unique<qrb::yolo_process::YoloPreProcessor>(
      shape, qrb::yolo_process::TensorDataType::FLOAT32);
...
RCLCPP_COMPONENTS_REGISTER_NODE(qrb_ros::yolo_process::YoloPreProcessNode)
