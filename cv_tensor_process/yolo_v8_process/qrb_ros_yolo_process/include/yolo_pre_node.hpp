...
#ifndef _QRB_ROS_YOLO_PROCESS_PREPROCESS_HPP_
#define _QRB_ROS_YOLO_PROCESS_PREPROCESS_HPP_

#include "qrb_ros_tensor_list_msgs/msg/tensor.hpp"
#include "qrb_ros_tensor_list_msgs/msg/tensor_list.hpp"
#include "qrb_yolo_process/yolo_preprocess.hpp"
...
private:
  std::unique_ptr<qrb::yolo_process::YoloPreProcessor> processor_{ nullptr };
...
#endif  // _QRB_ROS_YOLO_PROCESS_PREPROCESS_HPP_
