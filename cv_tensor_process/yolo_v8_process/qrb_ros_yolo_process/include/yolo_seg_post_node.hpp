...
#ifndef _QRB_ROS_YOLO_PROCESS_SEGMENTATION_POSTPROCESS_NODE_HPP_
#define _QRB_ROS_YOLO_PROCESS_SEGMENTATION_POSTPROCESS_NODE_HPP_
...
#include "qrb_yolo_process/yolo_seg_postprocess.hpp"
...
private:
  ...
  /**
   * \brief Extract tensor info from msg "TensorList" and wrap it into qrb::yolo_process::Tensor
  ...
  void populate_tensor_from_msg(const custom_msg::TensorList::SharedPtr & msg,
      std::vector<qrb::yolo_process::Tensor> & tensor);
  ...
  std::unique_ptr<qrb::yolo_process::YoloSegPostProcessor> processor_{ nullptr };
...
#endif  //_QRB_ROS_YOLO_PROCESS_SEGMENTATION_POSTPROCESS_NODE_HPP_
